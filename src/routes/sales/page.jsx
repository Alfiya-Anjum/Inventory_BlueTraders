...
import { cn } from "@/utils/cn";
 // Assuming you have a utility function for adding sales
        ...
        <div className="card-body">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                className={cn(
                  "mt-1 block w-full rounded-md border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-50 p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600",
                )}
          ...
          <button
            className="mt-4 rounded-md bg-blue-500 dark:bg-blue-600 text-white px-4 py-2 hover:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600"
             onClick={() => alert("Sale added!")} // Replace with actual save logic
